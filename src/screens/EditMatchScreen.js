    ...
    try {
      ...
      if (foundMatch) {
        ...
        setFormData({
          ...
          matchOrder: foundMatch.matchOrder || 1,
          map: foundMatch.map || "",
          score1: foundMatch.score1.toString(),
          score2: foundMatch.score2.toString(),
          date: foundMatch.date.split("T")[0],
        });
      }
    } catch (error) {
  ...
  return (
    <Provider>
      <ScrollView style={styles.container} nestedScrollEnabled={true}>
        <Card style={styles.card}>
          <Card.Content>
            <Title style={styles.title}>Modifier le match</Title>
              ...
              <View style={styles.teamSelector}>
                ...
                <Menu
                  ...
                  anchor={
                    <Button
                      mode="outlined"
                      onPress={() => setTeam1MenuVisible(true)}
              ...
              <View style={styles.teamSelector}>
                ...
                <Menu
                  ...
                  anchor={
                    <Button
                      mode="outlined"
                      onPress={() => setTeam2MenuVisible(true)}
                      style={styles.teamButton}
                      contentStyle={styles.teamButtonContent}
                    >
